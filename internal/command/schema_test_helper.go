...
func testSchemas() map[string]schema.CapabilitySchema {
	return map[string]schema.CapabilitySchema{
		...
		"youtube.get_video_comments":        {Name: "youtube.get_video_comments", Parameters: []schema.CapabilityParam{{Name: "video_id", Type: "string", FlagName: "video-id"}, {Name: "url", Type: "string"}, {Name: "cursor", Type: "string"}, {Name: "sort", Type: "string", Enum: []string{"top", "newest"}}, {Name: "count", Type: "integer"}}},
		...
		"douyin.get_video_detail":           {Name: "douyin.get_video_detail", Parameters: []schema.CapabilityParam{{Name: "share_url", Type: "string", FlagName: "share-url"}, {Name: "aweme_id", Type: "string", FlagName: "aweme-id"}}},
