...
func testSchemas() map[string]schema.CapabilitySchema {
	return map[string]schema.CapabilitySchema{
		...
		"amazon.get_product":                amazonSchema("amazon.get_product", []schema.CapabilityParam{{Name: "asin", Type: "string", Required: true}, {Name: "market", Type: "string", Required: true}}),
		...
		"amazon.query_aba_keywords":         amazonSchema("amazon.query_aba_keywords", []schema.CapabilityParam{{Name: "keyword", Type: "string"}, {Name: "node_ids", Type: "string", FlagName: "node-ids"}, {Name: "page", Type: "integer", Default: 1}, {Name: "page_size", Type: "integer", Default: 40, FlagName: "page-size"}, {Name: "market", Type: "string"}}),
		...
		"amazon.get_product_reviews":        amazonSchema("amazon.get_product_reviews", []schema.CapabilityParam{{Name: "asin", Type: "string", Required: true}, {Name: "market", Type: "string", Required: true}, {Name: "start_date", Type: "string", FlagName: "start-date"}, {Name: "star", Type: "string", Enum: []string{"positive", "negative"}}, {Name: "only_purchase", Type: "boolean", FlagName: "only-purchase"}, {Name: "page_index", Type: "integer", FlagName: "page-index"}}),
		"amazon.get_category_best_sellers":  amazonSchema("amazon.get_category_best_sellers", []schema.CapabilityParam{{Name: "node_id", Type: "string", Required: true, FlagName: "node-id"}, {Name: "market", Type: "string", Required: true}, {Name: "query_start", Type: "string", FlagName: "query-start"}, {Name: "query_date", Type: "string", FlagName: "query-date"}, {Name: "query_days", Type: "integer", FlagName: "query-days"}}),
		"amazon.get_category_trend":         amazonSchema("amazon.get_category_trend", []schema.CapabilityParam{{Name: "node_id", Type: "string", Required: true, FlagName: "node-id"}, {Name: "market", Type: "string", Required: true}, {Name: "trend_types", Type: "array", Required: true, ItemsType: "string", Encoding: "csv", FlagName: "trend-types"}}),
		...
		"xiaohongshu.get_note_detail":       {Name: "xiaohongshu.get_note_detail", Parameters: []schema.CapabilityParam{{Name: "note_id", Type: "string", Required: true, FlagName: "note-id"}}},
